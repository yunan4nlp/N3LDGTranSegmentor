...
public:
	inline void initial(ModelParams& params, HyperParams& hyparams){
		...
		app_1C_C0.init(1, -1);
		app_1Wc0_C0.init(1, -1);
		app_2CT_1CT_CT0.init(1, -1);

		sep_1C_C0.init(1, -1);
		sep_1Wc0_C0.init(1, -1);
		sep_2CT_1CT_CT0.init(1, -1);
		sep_1W.init(1, -1);
		sep_1WD_1WL.init(1, -1);
		sep_1WSingle.init(1, -1);
		sep_1W_C0.init(1, -1);
		sep_2W_1W.init(1, -1);
		sep_2Wc0_1W.init(1, -1);
		sep_2Wcn_1W.init(1, -1);
		sep_2Wc0_1Wc0.init(1, -1);
		sep_2Wcn_1Wcn.init(1, -1);
		sep_2W_1WL.init(1, -1);
		sep_2WL_1W.init(1, -1);
		sep_2W_1Wcn.init(1, -1);
		sep_1Wc0_1WL.init(1, -1);
		sep_1Wcn_1WL.init(1, -1);

		for (int idx = 0; idx < sep_1Wci_1Wcn.size(); idx++) {
			sep_1Wci_1Wcn[idx].init(1, -1);
		}
